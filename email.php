...
$sql="SELECT `NFT_highest_bidder` FROM `NFT_info` WHERE NFT_id='$Tid'";
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" style="border-radius: 22px; padding:9px 20px" bgcolor="#50579e">
                                                                                         <a href ="http://wsum.art/bid_description.php?id='.$Tid.'"  style="font-size:14px; color:white; text-decoration:none" >
                                                                                            CLICK HERE
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
