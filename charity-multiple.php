...
<section class="create-single-collectible">
    <div class="create-form-here">
        <div class="banner-content-here py-5"> 
            <h2 class="text-center text-white">Charity NFT</h2>
            <div class="text-center text-white">
                <a class="text-white" href="/index.php">WSUM-NFT</a> &gt; <a class="text-white" href="my_item.php">Charity NFT</a>
            </div>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2 class="text_nft_heading mb-5">Charity NFT collectible</h2>
                </div>
                <div class="col-md-8">
                                        ...
                                        <form>
                                            <div class="form-group">
                                                ...
                                                <div class="service-fee-receive mt-3">
                                                    <div class="m-0">Service fee <span class="text_nft_heading" id="service">0.0%</span></div> 
                                                </div>
                                            </div>
                                        </form>
                                    </div>
        ...
        if (window.ethereum) {
            ...
            if (chainid == 0x38) {
                ...
                {     
                        ...
                        let treeroyalties=Number(100)-creationfees;
                        ...
                        var formdata = new FormData();
                                    ...
                                    formdata.append("tokenroyal",0);
                                    formdata.append("treeroyalties", treeroyalties );
                                    formdata.append("charity", 1 );
