                    ...
                    <div class="col-md-12">
                        <div class="social___tab">
                            <ul class="list-unstyled d-flex justify-content-center">
                                <li class="twitter_link" data-toggle="tooltip" data-placement="top" title="Share"><a href="https://twitter.com/intent/tweet?text=<?php echo $result['NFT_name'].", ".$result['NFT_discription']; ?> &url=http://wsum.art/buy_description.php?id=<?php echo $result['NFT_id']?>&ref_src=http://wsum.art/buy_description.php?id=<?php echo $result['NFT_id']?>" class="twitter_lin_k text-decoration-none"><i class="fab fa-twitter-square"></i></a></li>
                                 
                                <li class="twitter_link" data-toggle="tooltip" data-placement="top" title="Facebook">
                                <a href="http://www.facebook.com/sharer.php?u=http://wsum.art/buy_description.php?id=<?php echo $result['NFT_id']?>&p[title]=<?php echo $result['NFT_name'].",  ".$result['NFT_discription']; ?>" class="text-decoration-none facebook__shares"><i class="fab fa-facebook-square"></i></a></li>
                                <li class="twitter_link" data-toggle="tooltip" data-placement="top" title="linkedin"><a href="https://www.linkedin.com/shareArticle?mini=true&url={http://wsum.art/buy_description.php?id=<?php echo $result['NFT_id']?>}&title={<?php echo $result['NFT_name'].",  ".$result['NFT_discription']; ?>}" class="linkedin_post text-decoration-none"><i class="fab fa-linkedin"></i></a></li>
                        ...
                        <div class="sale_will_go_creator py-4">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="onsale_btn12 "> <?php echo $result['NFT_treeplant'];?> % of sales will go to Tree Plant 
                                    </div></a>
                                </div>
                                <!--<div class="col-md-3"></div>-->
                            </div>
...
<script>
  ...
  navigator.clipboard.writeText("http://wsum.art/buy_description.php?id=<?php echo $result['NFT_id'];?>");
...
<script>
 ...
 if(sell=='off')
 {
                                  ...
                                  let myContract1 = new wweb3.eth.Contract(wallet.contract_abi,wallet.contract_address);
                                            myContract1.methods
                                                ...
                                                .then((fees) => {
                                                    ...
                                                    // document.getElementById("submit1").innerHTML = Number(total)+ " BNB";
                                                })
                                                .catch(console.log);
                                        })
                                        .catch(console.log);
    ...
    async function myFunction(){
         ...
         let NFTnew="<?php echo $result['NFT_price'];?>";
        ...
        async function buyNFT(total1)
            {     let NFTprice="<?php echo $result['NFT_price'];?>";
                  ...
                  let NFT_paymenCurrency="<?php echo $result['NFT_paymenCurrency'];?>";
                  let payment="<?php echo $result['NFT_payment'];?>";
                  let NFTpriceneww="<?php echo $result['NFT_price'];?>";
              window.web3 = new Web3(window.ethereum);
                    const accounts = await ethereum.request({ method: 'eth_requestAccounts'});
                    const account = accounts[0];
            ...
            //------------------------------------------------------------------   
                         var formdata = new FormData();
                            formdata.append("value", NFTpriceneww);
                            formdata.append("owner", accounts[0]);
