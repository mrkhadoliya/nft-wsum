        ...
        <div class="container">
            ...
            <div class="row">
               <?php
                ...
                $query1 = "SELECT NFT_user.verify ,NFT_info.ID,NFT_info.nft_priority, NFT_info.NFT_owner_address, NFT_info.NFT_image,NFT_info.NFT_owner FROM `NFT_info` INNER JOIN NFT_user On NFT_user.Useraddress=NFT_info.NFT_owner_address WHERE NFT_info.nft_priority=1 group by NFT_user.verify ,NFT_info.NFT_owner_address, NFT_info.NFT_image ,NFT_info.NFT_owner ,NFT_info.ID ORDER BY ID DESC LIMIT 1";
                ...
                <div class="col-md-6 col-12">
                    <div class="row">
                         <?php
                               ...
                               $queryy ="SELECT NFT_user.verify ,NFT_info.ID,NFT_info.nft_priority, NFT_info.NFT_owner_address, NFT_info.NFT_image,NFT_info.NFT_owner FROM `NFT_info` INNER JOIN NFT_user On NFT_user.Useraddress=NFT_info.NFT_owner_address WHERE NFT_info.nft_priority=2 group by NFT_user.verify ,NFT_info.NFT_owner_address, NFT_info.NFT_image ,NFT_info.NFT_owner ,NFT_info.ID ORDER BY ID DESC LIMIT 1";
                        ...
                        ?>
                         <?php
                               $newqueryy ="SELECT NFT_user.verify ,NFT_info.ID,NFT_info.nft_priority, NFT_info.NFT_owner_address, NFT_info.NFT_image,NFT_info.NFT_owner FROM `NFT_info` INNER JOIN NFT_user On NFT_user.Useraddress=NFT_info.NFT_owner_address WHERE NFT_info.nft_priority=3 group by NFT_user.verify ,NFT_info.NFT_owner_address, NFT_info.NFT_image ,NFT_info.NFT_owner ,NFT_info.ID ORDER BY ID DESC LIMIT 1";
                      ...
                      <div class="row">
                         <?php
                               $newquery ="SELECT NFT_user.verify ,NFT_info.ID,NFT_info.nft_priority, NFT_info.NFT_owner_address, NFT_info.NFT_image,NFT_info.NFT_owner FROM `NFT_info` INNER JOIN NFT_user On NFT_user.Useraddress=NFT_info.NFT_owner_address WHERE NFT_info.nft_priority=4 group by NFT_user.verify ,NFT_info.NFT_owner_address, NFT_info.NFT_image ,NFT_info.NFT_owner ,NFT_info.ID ORDER BY ID DESC LIMIT 1";
                        ...
                        ?>
                        <?php
                           $newqueryy1 ="SELECT NFT_user.verify ,NFT_info.ID,NFT_info.nft_priority, NFT_info.NFT_owner_address, NFT_info.NFT_image,NFT_info.NFT_owner FROM `NFT_info` INNER JOIN NFT_user On NFT_user.Useraddress=NFT_info.NFT_owner_address WHERE NFT_info.nft_priority=5 group by NFT_user.verify ,NFT_info.NFT_owner_address, NFT_info.NFT_image ,NFT_info.NFT_owner ,NFT_info.ID ORDER BY ID DESC LIMIT 1";
                     ...
                     <div class="nkadv row text-center">
                        ...
                        <div class="col-md-11 col-12 m-md-auto">
                             <div class="text-center pb-4">
                                    <a href="https://bscscan.com/address/0x37C7D580ae7200A38a96E8058A0D5d443c84ccd7" target="blank"class="m-auto onsale_btn12 d-block my-4 " style="font-size: 19px;" id="treeplantdollar">Buying and selling WSUM to benefit &nbnsp;<?php echo number_format($datatree['treeplant'],2);?> % to nonprofit tree plant organizations </a>
                                </div>
                        </div>
                        </div>
                     </div>
                            ...
                            <div class="dropdown d-flex align-items-center justify-content-center">
                                ...
                                <div class="dropdown-menu Filter_show" aria-labelledby="dropdownMenuButton">
                                    <div class="radio_box">
                                        ...
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="BNBcoin" value="BNB" >-->
                                        <!--  <label class="form-check-label" for="BNB">-->
                                        <!--   BNB-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="WSBCcoin" value="WSBC" >-->
                                        <!--  <label class="form-check-label" for="WSBC">-->
                                        <!--   WSBC-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="WBBWcoin" value="WBBW" >-->
                                        <!--  <label class="form-check-label" for="WBBW">-->
                                        <!--   WBBW-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="EJCOcoin" value="EJCO" >-->
                                        <!--  <label class="form-check-label" for="EJCO">-->
                                        <!--   EJCO-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="QBBWcoin" value="QBBW" >-->
                                        <!--  <label class="form-check-label" for="QBBW">-->
                                        <!--   QBBW-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="BUSDcoin" value="BUSD" >-->
                                        <!--  <label class="form-check-label" for="BUSD">-->
                                        <!--   BUSD-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="WBTCcoin" value="WBTC" >-->
                                        <!--  <label class="form-check-label" for="WBTC">-->
                                        <!--  WBTC-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="BETHcoin" value="BETH" >-->
                                        <!--  <label class="form-check-label" for="BETH">-->
                                        <!--   BETH-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                        <!--<div class="form-check">-->
                                        <!--  <input class="form-check-input" type="radio" name="select" id="WSUMcoin" value="WSUM" >-->
                                        <!--  <label class="form-check-label" for="WSUM">-->
                                        <!--   WSUM-->
                                        <!--  </label>-->
                                        <!--</div>-->
                                    </div>
