...
<div class="wsum-nft-buy_description-page"> 
        <div class="banner-content-here py-md-5 py-3"> 
            ...
            <div class="text-center text-white">
                <a class="text-white" href="index1.php">WSUM-ART</a> > <a class="text-white" href="buy_description.php">BUY-DESCRIPTION</a>
            </div>
        </div> 
                    ...
                    <div class="col-md-12">
                        <div class="social___tab">
                            <ul class="list-unstyled d-flex justify-content-center">
                                <li class="facebook_share"><a href="#" class="text-white text-decoration-none d-block"><i class="fab fa-facebook-f"></i>&nbsp; share</a></li>
                                <li class="twitter_link"><a href="#" class="text-white text-decoration-none d-block"><i class="fab fa-twitter"></i>&nbsp; twitter</a></li>
                                <li class="copy_link"><button onclick="copyfunction()" id="copylink">Copy link</button></li>
                            </ul>
                        </div>
                    </div> 
                </div>
                                                            ...
                                                            <div class="content-line">
                                                                ...
                                                                <div class="common-content-box-this">
                                                                  <div class="type">
                                                                      ...
                                                                      <h6 class="font-weight-bold text_nft_heading d-flex">Address &nbsp; <span class="text-muted dnbskd_has font-weight-normal"><a href="./collection.php?address=<?php echo $result['NFT_owner_address'];?>"> 
...
<script>
  ...
  navigator.clipboard.writeText("https://ramlogics.com/WSUMART/new-buy-description.php?id=63569");
    }
</script>
     <!--SHOW LOADING IMAGE-->
 ...
 if(sell=='off')
 {
    ...
    async function myFunction(){
         ...
         if (resellAmount=="")
         {
            ...
            //------------------------------------------------------------------   
                         var formdata = new FormData();
                            formdata.append("value", Number(NFTpricenew));
                            formdata.append("owner", accounts[0]);
