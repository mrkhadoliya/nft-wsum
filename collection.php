                    ...
                    <div class="col-md-auto profile-content1 text-center">
                        <div class="collection_social">
                            <ul class="list-inline mb-0">
                              <li class="list-inline-item"><a class="" href="https://twitter.com/intent/tweet?text=<?php echo $data['Userbio']?> &url=http://wsum.art/collection.php?address=<?php echo $data['Useraddress']?>" tager="_blank"><i class="fab fa-twitter"></i></a></li> &nbsp; &nbsp;
                              <li class="list-inline-item"><a class="" href="http://www.facebook.com/sharer.php?u=http://wsum.art/collection.php?address=<?php echo $data['Useraddress']?>&p[title]=<?php echo $data['Userbio']?>" tager="_blank"><i class="fab fa-facebook-f"></i></a></li> &nbsp; &nbsp;
                              <li class="list-inline-item"><a class="" href="https://www.linkedin.com/shareArticle?mini=true&url={http://wsum.art/collection.php?address=<?php echo $data['Useraddress']?>}&title={<?php echo $data['Userbio']?>}" tager="_blank"><i class="fab fa-linkedin-in"></i></a></li>  &nbsp;
                            </ul>
                      </div>
                    </div>
                </div>
                                                                            ...
                                                                            <div class="dropdown_h_toggle">
                                                                                ...
                                                                                <div class="dropdown_hv_menu">
                                                                                    <ul class="list-unstyled d-flex m-0">
                                                                                        <li class="m-2"><a href="https://twitter.com/intent/tweet?text=${nft_info[i].NFT_name}", "${nft_info[i].NFT_description} &url=http://wsum.art/bid_description.php?id=${nft_info[i].NFT_id}&ref_src=http://wsum.art/collection.php/bid_description.php?id=${nft_info[i].NFT_id}" target="blank"><i class="fab fa-twitter"></i></a></li>
                                                                                        <li class="m-2"><a href="http://www.facebook.com/sharer.php?u=http://wsum.art/bid_description.php?id=${nft_info[i].NFT_id}&p[title]=${nft_info[i].NFT_name + nft_info[i].NFT_discription}" target="blank"><i class="fab fa-facebook"></i></a></li>
                                                                                        <li class="m-2"><a href="https://www.linkedin.com/shareArticle?mini=true&url={http://wsum.art/bid_description.php?id=${nft_info[i].NFT_id}}&title={${nft_info[i].NFT_name + nft_info[i].NFT_discription}}" target="blank"><i class="fab fa-linkedin-in"></i></a></li>
                                                                                       </ul>
                                                                                </div>
                                                                            </div>
