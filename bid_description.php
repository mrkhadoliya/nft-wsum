...
<section class="wsum-nft-buy_description-page">
    <div class="banner-content-here py-md-5 py-3">
        ...
        <div class="text-center text-white">
            <a class="text-white" href="index.php">WSUM-ART</a> > 
                    ...
                    <div class="col-md">
                        <div class="social___tab">
                            <ul class="list-unstyled d-flex justify-content-center">
                                <li class="twitter_link" data-toggle="tooltip" data-placement="top" title="Share"><a href="https://twitter.com/intent/tweet?text=<?php echo $result['NFT_name'].", ".$result['NFT_discription']; ?> &url=http://wsum.art/bid_description.php?id=<?php echo $result['NFT_id']?>&ref_src=http://wsum.art/bid_description.php?id=<?php echo $result['NFT_id']?>" class="twitter_lin_k text-decoration-none"><i class="fab fa-twitter-square"></i></a></li>
                                 
                                <li class="twitter_link" data-toggle="tooltip" data-placement="top" title="Facebook">
                                    <a href="http://www.facebook.com/sharer.php?u=http://wsum.art/bid_description.php?id=<?php echo $result['NFT_id']?>&p[title]=<?php echo $result['NFT_name'].",  ".$result['NFT_discription']; ?>" class="text-decoration-none facebook__shares"><i class="fab fa-facebook-square"></i></a></li>
                                <li class="twitter_link" data-toggle="tooltip" data-placement="top" title="linkedin"><a href="https://www.linkedin.com/shareArticle?mini=true&url={http://wsum.art/bid_description.php?id=<?php echo $result['NFT_id']?>}&title={<?php echo $result['NFT_name'].",  ".$result['NFT_discription']; ?>}" class="linkedin_post text-decoration-none"><i class="fab fa-linkedin"></i></a></li>
                    ...
                    <div class="detail-right-side">
                        <div class="head-detail">
                            <div class="row">
                                ...
                                <div class="col-auto"> 
                                    <div class="pt-2 m-0">
                                        <h5 class="d-flex"> Highest bid  &nbsp;<span class="text_nft_heading"> <?php echo $result['NFT_highest_bid'];?> <?php echo $result['NFT_payment'];?> </span> </h5>
                                    </div>
                                </div> 
                            </div>
                            <div>
                                <p class="py-3"> <span> Description: <?php echo $result['NFT_discription'];?> </span> </p>
                            </div>
                            <hr />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <a href="https://bscscan.com/address/<?php echo $result['NFT_creator_add'];?> " target="_blank">
                                            <div class="onsale_btn11">
                                             <?php echo $result['NFT_royalties'];?>% of sales will go to creator
                                        </div> </a>
                                    </div>
                                    <div class="col-md-6">
                                        <a href="https://bscscan.com/address/0x37C7D580ae7200A38a96E8058A0D5d443c84ccd7" >
                                            <div class="onsale_btn12">
                                                <?php echo $result['NFT_treeplant'];?> % of sales will go to Tree Plant
                                             </div> 
                                         </a>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                        <div class="timer_container">
                                            <div class="dfjnbl text-center"> 
                                                <h4 class="text_nft_heading">Auction Will End In</h4>
                                                <h3 class="text_gredient m-0"> <span id="clock<?php echo $result['ID'];?>"></span></h3> 
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                                ...
                                                <div class="detail-tab-set"> 
                                                    <div class="row">
                                                        ...
                                                        <div  class="col right-img-in-here1">
                                                            <div class="content-line">
                                                                <div class="d-flex text_nft_heading d-flex"><b><?php echo $result['NFT_owner'];?></b> &nbsp;
                                                                    <a href="./collection.php?address=<?php echo $result['NFT_owner_address'];?>">  <span class="text-muted dnbskd_has"><?php echo $result['NFT_owner_address'];?></span></a>
                                                                </div>
                                                                <div class="d-flex"> 
                                                                    <span><?php echo $result['NFT_price'];?> <?php echo $result['NFT_payment'];?></span> &nbsp; <div class="px-2 m-0">6/10/2021,<span class="text_nft_heading"> 10:20 AM</span></div>
                                                                </div>
                                                     ...
                                                     <?php
                                                        ...
                                                        <div class="detail-tab-set">
                                                            <div class="row">
                                                                <div class="col-auto left-img-in-here1">
                                                                    <div class="mt-2">
                                                                        <img src="<?php echo $mydata['Userimage'];?>" class="" />
                                                                    </div>
                                                                </div>
                                                                <div class="col right-img-in-here1">
                                                                    <div class="content-line"> 
                                                                        <div class="d-flex text_nft_heading"><b><?php echo $mydata['Username'];?></b> &nbsp;
                                                                            <a href="./collection.php?address=<?php echo $mydata['NFT_bidder_add'];?>"><span class="text-muted dnbskd_has"><?php echo $mydata['NFT_bidder_add'];?></span> </a>
                                                                        </div>  
                                                                        <div class="px-2"><span><?php echo $mydata['NFT_bid'];?></span><?php echo $result['NFT_payment'];?>&nbsp; <span class="text_nft_heading"><?php echo $mydata['NFT_bidtime'];?></span></div>
                            ...
                            <hr/>
                            <div class="heighest-bid-here-btns">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="eddition-here-btns_width">
                                            <div class="row">
                                                <div class="col-auto left-img-in-here1">
                                                    <img src="<?php echo $result['Nft_owner_image'];?>" style="border-radius: 50%; height: 45px; width: 45px;" class="" />
                                                </div>
                                                <div class="col right-img-in-here1">
                                                    <div class="content-line">
                                                        <div class="d-flex text_nft_heading"> <b><?php echo $result['NFT_creator'];?></b> &nbsp;
                                                         <a href="./collection.php?address=<?php echo $result['NFT_creator_add'];?>">   <span class="text-muted dnbskd_has" style="color: #000;"><?php echo $result['NFT_creator_add'];?></span></a>
                                                        </div>
                                                        <div class=""><span><?php echo $result['NFT_price'];?> <?php echo $result['NFT_payment'];?></span> &nbsp; <span class="text_nft_heading" style="color: #000;"><?php echo $result['NFT_time'];?></span></div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="nsjkdfhgl py-4">
                                            ...
                                            <div class="d-flex align-items-center py-3">
                                                <input type="checkbox" id="checkbox" name="vehicle1" value="">
                                                <a href="./WSUMterms.pdf" id="Accpect" target="_blank"> &nbsp; <label class="m-0" for="vehicle1" id="Terms"> I Accept Terms & Conditions </label></a>   
                                            </div>
                                            
                                            <button class="btn onsale-btn w-100" data-toggle="modal" id="hide"   data-target="#myModal" disabled>Place a bid</button>
...
<script>
  ...
  navigator.clipboard.writeText("http://wsum.art/bid_description.php?id=<?php echo $result['NFT_id'];?>");
...
<script>
 ...
 async function claim(){
         ...
         let Nftunique="<?php echo $result['NFT_highest_bid'];?>";
         ...
         if (resellAmount=="")
         {
            ...
            //------------------------------------------------------------------   
                         var formdata = new FormData();
                            formdata.append("value", Nftunique);
                            formdata.append("owner", accounts[0]);
    ...
    async function buyNFT(total1)
        {     let NFTprice="<?php echo $result['NFT_highest_bid'];?>";
            ...
            //------------------------------------------------------------------   
                         var formdata = new FormData();
                            formdata.append("value", NFTprice);
                            formdata.append("owner", accounts[0]);
